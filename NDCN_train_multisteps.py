...
from utils.preprocess import load_graphs, get_context_pairs, get_evaluation_data,get_multistep_evaluation_data
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        model.eval()
        emb1 = model(vt, feat)[-5].detach().cpu().numpy()
        ...
        emb2 = model(vt, feat)[-4].detach().cpu().numpy()
        ...
        emb3 = model(vt, feat)[-3].detach().cpu().numpy()
        ...
        emb4 = model(vt, feat)[-2].detach().cpu().numpy()
        ...
        emb5 = model(vt, feat)[-4].detach().cpu().numpy()
