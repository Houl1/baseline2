...
def get_user_score(train_pos, train_neg, val_pos, val_neg, test_pos, test_neg, source_embeds, target_embeds):
    ...
    for operator in operatorTypes:
        ...
        test_ap_score = average_precision_score(test_labels, test_predict, average="macro")
    ...
    return val_results, test_results, val_pred_true, test_pred_true,test_ap_score
...
# def get_user_score(emb,test_original,test_new):
#     test = emb[test_original]
#     predict = emb[test_new]

#     mean_squared_error_t = mean_squared_error(test, predict)
#     mean_absolute_error_t = mean_absolute_error(test, predict)
